#!/usr/bin/env python3
"""Build residual LSTM numpy sequences and scalers."""

from sequence.residual_pipeline import run_pipeline


def main() -> None:
    report = run_pipeline()
    print("Residual sequence dataset built.")
    print("Output dir:", report["output_dir"])
    print("Features:", report["feature_count"], "| Residual targets:", report["target_count"])
