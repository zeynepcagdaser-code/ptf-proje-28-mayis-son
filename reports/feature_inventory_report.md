...
|---------|--------|---------|--------------|---------|----------|-------:|
| `ptf_lag_1` | ptf_lag_rolling | ptf_price | lag_required | low | low_price_classifier | 0.00 |
| `ptf_lag_168` | ptf_lag_rolling | ptf_price | lag_required | low | main_regression | 0.00 |
| `ptf_lag_168h` | ptf_lag_rolling | ptf_price | lag_required | low | exclude | 0.00 |
| `ptf_lag_1h` | ptf_lag_rolling | ptf_price | lag_required | low | exclude | 0.00 |
| `ptf_lag_2` | ptf_lag_rolling | ptf_price | lag_required | low | low_price_classifier | 0.00 |
| `ptf_lag_24` | ptf_lag_rolling | ptf_price | lag_required | low | main_regression | 0.00 |
| `ptf_lag_24h` | ptf_lag_rolling | ptf_price | lag_required | low | exclude | 0.00 |
| `ptf_lag_2h` | ptf_lag_rolling | ptf_price | lag_required | low | exclude | 0.00 |
| `ptf_lag_3` | ptf_lag_rolling | ptf_price | lag_required | low | low_price_classifier | 0.00 |
| `ptf_lag_3h` | ptf_lag_rolling | ptf_price | lag_required | low | exclude | 0.00 |
| `ptf_lag_48` | ptf_lag_rolling | ptf_price | lag_required | low | exclude | 0.00 |
| `ptf_roll_max_168` | ptf_lag_rolling | ptf_price | lag_required | low | low_price_classifier | 0.00 |
| `ptf_roll_max_24` | ptf_lag_rolling | ptf_price | lag_required | low | low_price_classifier | 0.00 |
...
| `ptf_roll_min_168` | ptf_lag_rolling | ptf_price | lag_required | low | low_price_classifier | 0.00 |
| `ptf_roll_min_24` | ptf_lag_rolling | ptf_price | lag_required | low | low_price_classifier | 0.00 |
...
| `ptf_rolling_mean_168h` | ptf_lag_rolling | ptf_price | lag_required | low | exclude | 0.00 |
| `ptf_rolling_mean_24h` | ptf_lag_rolling | ptf_price | lag_required | low | exclude | 0.00 |
| `ptf_rolling_std_24h` | ptf_lag_rolling | ptf_price | lag_required | low | exclude | 0.00 |
...
| `is_holiday_or_weekend` | calendar_holiday | ts_hour, holidays.Turkey() | same_hour_ok | low | low_price_classifier | 0.00 |
...
| `kgup_biokutle` | kgup_source_mix | kgup_biokutle | same_hour_ok | low | exclude | 0.00 |
| `kgup_diger` | kgup_source_mix | kgup_diger | same_hour_ok | low | exclude | 0.00 |
| `kgup_dogalgaz` | kgup_source_mix | kgup_dogalgaz | same_hour_ok | low | main_regression | 0.00 |
| `kgup_fuelOil` | kgup_source_mix | kgup_fuelOil | same_hour_ok | low | exclude | 0.00 |
...
| `kgup_jeotermal` | kgup_source_mix | kgup_jeotermal | same_hour_ok | low | exclude | 0.00 |
| `kgup_linyit` | kgup_source_mix | kgup_linyit | same_hour_ok | low | main_regression | 0.00 |
| `kgup_nafta` | kgup_source_mix | kgup_nafta | same_hour_ok | low | exclude | 0.00 |
...
| `hydro_share` | renewable_pressure | kgup_toplam, kgup_ruzgar, kgup_gunes, kgup_barajli, kgup_akarsu, kgup_biokutle, kgup_jeotermal | same_hour_ok | low | low_price_classifier | 0.00 |
...
| `res_share` | renewable_pressure | kgup_toplam, kgup_ruzgar, kgup_gunes, kgup_barajli, kgup_akarsu, kgup_biokutle, kgup_jeotermal | same_hour_ok | low | low_price_classifier | 0.00 |
| `solar_share` | renewable_pressure | kgup_toplam, kgup_ruzgar, kgup_gunes, kgup_barajli, kgup_akarsu, kgup_biokutle, kgup_jeotermal | same_hour_ok | low | low_price_classifier | 0.00 |
...
| `gas_coal_balance` | thermal_price_setting | kgup_toplam, kgup_dogalgaz, kgup_ithalKomur, kgup_linyit, kgup_tasKomur | same_hour_ok | low | exclude | 0.00 |
...
| `fiba_fibs_ratio_lag_168` | smf_yal_yat_lagged | - | lag_required | low | main_regression | 0.00 |
| `fiba_fibs_ratio_lag_24` | smf_yal_yat_lagged | - | lag_required | low | main_regression | 0.00 |
| `gen_total_lag_168` | smf_yal_yat_lagged | - | lag_required | low | exclude | 0.00 |
| `gen_total_lag_24` | smf_yal_yat_lagged | - | lag_required | low | risk_dashboard_only | 0.00 |
| `gen_total_lag_48` | smf_yal_yat_lagged | - | lag_required | low | exclude | 0.00 |
| `smf_lag_168` | smf_yal_yat_lagged | smf_systemMarginalPrice, ptf_price | lag_required | low | risk_dashboard_only | 0.00 |
| `smf_lag_24` | smf_yal_yat_lagged | smf_systemMarginalPrice, ptf_price | lag_required | low | risk_dashboard_only | 0.00 |
| `smf_lag_48` | smf_yal_yat_lagged | smf_systemMarginalPrice, ptf_price | lag_required | low | risk_dashboard_only | 0.00 |
| `smf_ptf_spread_lag_168` | smf_yal_yat_lagged | smf_systemMarginalPrice, ptf_price | lag_required | low | risk_dashboard_only | 0.00 |
| `smf_ptf_spread_lag_24` | smf_yal_yat_lagged | smf_systemMarginalPrice, ptf_price | lag_required | low | risk_dashboard_only | 0.00 |
| `smf_to_cap_ratio` | smf_yal_yat_lagged | smf_systemMarginalPrice, ptf_price | lag_required | low | risk_dashboard_only | 0.00 |
| `wind_generation_mean_lag_168` | smf_yal_yat_lagged | wind_* (master) | lag_required | low | risk_dashboard_only | 0.43 |
| `wind_generation_mean_lag_24` | smf_yal_yat_lagged | wind_* (master) | lag_required | low | risk_dashboard_only | 0.43 |
| `wind_generation_mean_lag_48` | smf_yal_yat_lagged | wind_* (master) | lag_required | low | risk_dashboard_only | 0.43 |
| `yal_yat_downRegulationDelivered_lag_168` | smf_yal_yat_lagged | yal_yat_* (master) | lag_required | low | exclude | 0.00 |
| `yal_yat_downRegulationDelivered_lag_24` | smf_yal_yat_lagged | yal_yat_* (master) | lag_required | low | risk_dashboard_only | 0.00 |
| `yal_yat_downRegulationDelivered_lag_48` | smf_yal_yat_lagged | yal_yat_* (master) | lag_required | low | exclude | 0.00 |
| `yal_yat_net_lag_168` | smf_yal_yat_lagged | yal_yat_* (master) | lag_required | low | risk_dashboard_only | 0.00 |
| `yal_yat_net_lag_24` | smf_yal_yat_lagged | yal_yat_* (master) | lag_required | low | risk_dashboard_only | 0.00 |
| `yal_yat_net_lag_48` | smf_yal_yat_lagged | yal_yat_* (master) | lag_required | low | risk_dashboard_only | 0.00 |
| `yal_yat_upRegulationDelivered_lag_168` | smf_yal_yat_lagged | yal_yat_* (master) | lag_required | low | exclude | 0.00 |
| `yal_yat_upRegulationDelivered_lag_24` | smf_yal_yat_lagged | yal_yat_* (master) | lag_required | low | risk_dashboard_only | 0.00 |
| `yal_yat_upRegulationDelivered_lag_48` | smf_yal_yat_lagged | yal_yat_* (master) | lag_required | low | exclude | 0.00 |
| `wind_forecast_max` | wind_forecast | wind_* (master) | same_hour_ok | low | exclude | 0.04 |
| `wind_forecast_mean` | wind_forecast | wind_* (master) | same_hour_ok | low | main_regression | 0.04 |
| `wind_forecast_min` | wind_forecast | wind_* (master) | same_hour_ok | low | exclude | 0.04 |
| `wind_forecast_std` | wind_forecast | wind_* (master) | same_hour_ok | low | exclude | 0.04 |
| `wind_quarter1_mean` | wind_forecast | wind_* (master) | same_hour_ok | low | main_regression | 0.00 |
| `wind_quarter2_mean` | wind_forecast | wind_* (master) | same_hour_ok | low | exclude | 0.04 |
| `wind_quarter3_mean` | wind_forecast | wind_* (master) | same_hour_ok | low | exclude | 0.04 |
| `wind_quarter4_mean` | wind_forecast | wind_* (master) | same_hour_ok | low | exclude | 0.04 |
...
| `outage_fault_mw_loss_max` | outage | outages_* (master) | same_hour_ok | low | exclude | 0.25 |
| `outage_fault_mw_loss_sum` | outage | outages_* (master) | same_hour_ok | low | exclude | 0.25 |
| `outage_fault_operator_power_sum` | outage | outages_* (master) | same_hour_ok | low | exclude | 0.25 |
...
| `outage_maint_operator_power_sum` | outage | outages_* (master) | same_hour_ok | low | exclude | 0.00 |
| `grf_eur_mwh` | fuel_currency | - | same_hour_ok | medium | risk_dashboard_only | 0.00 |
| `grf_usd_1000sm3` | fuel_currency | - | same_hour_ok | medium | risk_dashboard_only | 0.00 |
| `grf_usd_mmbtu` | fuel_currency | - | same_hour_ok | medium | risk_dashboard_only | 0.00 |
...
| `fiba_fibs_total` | other | - | same_hour_ok | medium | exclude | 0.00 |
| `gas_cost_pressure` | other | - | same_hour_ok | medium | risk_dashboard_only | 0.00 |
| `gas_cost_pressure_lag_1d` | other | - | same_hour_ok | medium | main_regression | 0.00 |
| `gas_marginal_pressure` | other | - | same_hour_ok | medium | risk_dashboard_only | 0.00 |
| `gas_marginal_pressure_lag_1d` | other | - | same_hour_ok | medium | main_regression | 0.00 |
| `grf_tl_1000sm3` | other | - | same_hour_ok | medium | risk_dashboard_only | 0.00 |
| `grf_tl_change_7d` | other | - | same_hour_ok | medium | main_regression | 0.04 |
| `grf_tl_lag_1d` | other | - | same_hour_ok | medium | main_regression | 0.00 |
| `grf_tl_rolling_mean_7d` | other | - | same_hour_ok | medium | main_regression | 0.04 |
| `ptf_low_count_168` | other | ptf_price | same_hour_ok | medium | low_price_classifier | 0.00 |
| `ptf_low_count_24` | other | ptf_price | same_hour_ok | medium | low_price_classifier | 0.00 |
| `ptf_low_ratio_168` | other | ptf_price | same_hour_ok | medium | low_price_classifier | 0.00 |
| `ptf_low_ratio_24` | other | ptf_price | same_hour_ok | medium | low_price_classifier | 0.00 |
| `ptf_zero_count_168` | other | ptf_price | same_hour_ok | medium | low_price_classifier | 0.00 |
| `ptf_zero_count_24` | other | ptf_price | same_hour_ok | medium | low_price_classifier | 0.00 |
| `ptf_zero_ratio_168` | other | ptf_price | same_hour_ok | medium | low_price_classifier | 0.00 |
| `ptf_zero_ratio_24` | other | ptf_price | same_hour_ok | medium | low_price_classifier | 0.00 |
| `thermal_cost_pressure` | other | - | same_hour_ok | medium | risk_dashboard_only | 0.00 |
| `thermal_cost_pressure_lag_1d` | other | - | same_hour_ok | medium | main_regression | 0.00 |
