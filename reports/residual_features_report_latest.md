...
- **Generated (UTC):** 2026-05-29T23:39:40.656999+00:00
- **Output:** `/Users/salihcagdaser/Desktop/ptf-proje-28-may-s/data/features/lstm_residual_next24_v1.parquet`
...
- **Index mapping:** `X[t-167:t] -> y_residual[t+1:t+24] at anchor ts_hour=t`
...
- [PASS] Persistence uses PTF(t+h-24) only — max lag is PTF(t) at h=24: persistence_h = ptf_price.shift(24-h) at anchor t
- [PASS] Residual target = future PTF minus persistence (not in feature matrix): target_residual_h stored separately from X features